        ...
        <section className="py-20 lg:py-28">
          <div className="mx-auto max-w-[1400px] px-6 sm:px-10 lg:px-16">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <Section className="space-y-5 text-[16px] leading-[1.75] text-slate-600">
                <p>
        ...
        <section className="py-20 lg:py-28 bg-gradient-to-b from-[#F5F3FF]/40 to-white">
          <div className="mx-auto max-w-[1400px] px-6 sm:px-10 lg:px-16">
            <Section className="max-w-xl mb-14">
              <p className="text-[13px] font-bold text-brand uppercase tracking-wider mb-4">Our values</p>
              <h2 className="text-[2rem] sm:text-[2.4rem] font-extrabold leading-[1.12] tracking-[-0.03em] text-slate-900">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {values.map((v, i) => {
                const Icon = v.icon;
                return (
                  <Section key={v.title} className={`rounded-2xl bg-white border border-slate-200/80 p-7 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300`}>
                    ...
                    <p className="mt-2.5 text-[14px] text-slate-600 leading-[1.65]">{v.description}</p>
                  </Section>
                );
              })}
            </div>
        ...
        <section className="py-20 lg:py-28">
          <div className="mx-auto max-w-[1400px] px-6 sm:px-10 lg:px-16">
            <Section className="text-center max-w-lg mx-auto mb-14">
              <p className="text-[13px] font-bold text-brand uppercase tracking-wider mb-4">The team</p>
              <h2 className="text-[2rem] sm:text-[2.4rem] font-extrabold leading-[1.12] tracking-[-0.03em] text-slate-900">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5">
              {team.map((t) => (
                <Section key={t.name} className="text-center">
                  ...
                  <h3 className="text-[14px] font-bold text-slate-900">{t.name}</h3>
          ...
          <div className="mx-auto max-w-[1400px] px-6 sm:px-10 lg:px-16">
            <Section className="rounded-[2rem] bg-gradient-to-br from-slate-900 via-[#1a1040] to-brand-dark px-8 py-16 sm:px-16 sm:py-20 text-center relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <a
                  href="/contact"
                  className="group inline-flex items-center gap-2 mt-8 rounded-xl bg-white px-7 py-3.5 text-[15px] font-bold text-slate-900 hover:bg-slate-50 hover:-translate-y-0.5 transition-all duration-200"
                >
                  Get in touch
