          ...
          >
            <AnimatePresence>
              {isActive && (
                <motion.div
                  ...
                  className="absolute -inset-1.5 rounded-2xl bg-brand/8 blur-sm"
                />
              )}
            </AnimatePresence>
            <div
              className={`relative rounded-xl px-5 py-3 sm:px-6 sm:py-3.5 text-[14px] sm:text-[16px] font-bold transition-colors duration-300 ${
                isActive
                  ? "bg-white text-slate-900 shadow-lg shadow-brand/10 border border-brand/20 ring-2 ring-brand/15"
            ...
            >
              {isActive && (
                <motion.span
                  layoutId="lensDot"
                  className="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-brand shadow-sm shadow-brand/40"
...
/* ── Compact time bar ── */
const timeBlocks = [
  { label: "Email & comms", pct: 28, color: "bg-coral" },
  { label: "Data entry", pct: 19, color: "bg-amber" },
  { label: "Reports", pct: 14, color: "bg-brand" },
  { label: "Doc processing", pct: 11, color: "bg-sky" },
  { label: "Strategic work", pct: 28, color: "bg-emerald" },
];
